...
highSchool = {
    ...
    'downloadData': requests.get("https://quality.data.gov.tw/dq_download_json.php?nid=6089&md5_url=58e949f445c4e8fec0ef78ad1be3d771", verify=False)
}
# 國中
junior = {
    'name': '國中資料集',
...
elementary = {
    ...
    'downloadData': requests.get("https://quality.data.gov.tw/dq_download_json.php?nid=6087&md5_url=5825c099d4c7f424385afafbf2495d2d", verify=False)
}
# 資源較不足(國中小)
loseJunior = {
    'name': '資源較不足',
    'schools': "https://quality.data.gov.tw/dq_download_json.php?nid=28582&md5_url=ab863e631deac12a65ec30163c314f53",
    'downloadData': requests.get("https://quality.data.gov.tw/dq_download_json.php?nid=28582&md5_url=ab863e631deac12a65ec30163c314f53", verify=False)
}
###############
# 各縣市圖書館編列統計
twLibarys = {
